...
public class DubaiMallParkingLayoutFragment extends Fragment
{
    Toolbar toolbar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_dubai_mall_parking_layout, container, false);
    ...
    private void setupToolbar(View view)
    {
        ...
        toolbar_title.setText("Dubai Mall Parking Layout");
